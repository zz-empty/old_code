...
#if 0
    cout << endl;
    cout << "--------------test multimap::insert--------------" << endl;
    std::pair<multimap<int,string>::iterator, bool> ret = addr.insert(std::pair<int, string>(9, "henan"));
    if (ret.second) {
        cout << "insert succeed, ";
