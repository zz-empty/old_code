...
void test()
{
    ...
    cout << endl;
    cout << "--------------test unordered_map::insert--------------" << endl;
    std::pair<unordered_map<int,string>::iterator, bool> ret = addr.insert(std::pair<int, string>(9, "henan"));
    if (ret.second) {
        cout << "insert succeed, ";
...
void test_class()
{
    unordered_map<string, Point> addr = {
        {"beijing", Point(1, 1)},
        {"shanghai", Point(2, 3)},
